...
namespace BookProject.Controllers
{
    public class BooksController : Controller
    {
        ...
        [Authorize]
        public async Task<IActionResult> Create([Bind("Title,ImageUrl,GenreId,Id")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Title,ImageUrl,GenreId,Id")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
